...
import NecromergeShapeTriangle from "./NecromergeShapeTriangle";

/**
 * The drone class represents the drone (projectile) entity in diep.
 */
export default class NecromergeShapeSquare extends AbstractNecromergeShape {

    public static mergeResultShape = Triangle

    public static mergeResultShapeDrone = NecromergeShapeTriangle
    ...
    public static fromShape(barrel: Barrel, tank: BarrelBase, tankDefinition: TankDefinition | null, shape: AbstractShape): NecromergeShapeSquare {
        const droneShape = new NecromergeShapeSquare(barrel, tank, tankDefinition, shape.positionData.values.angle);
    ...
    public onCollide(entity1: LivingEntity, entity2: LivingEntity) {
        ...
        AbstractNecromergeShape.handleNecromergeShape(NecromergeShapeSquare, entity1, entity2)
    }
}