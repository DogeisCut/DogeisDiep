 ...
 */
export default class WraithSquare extends Minion {
    ...
    public static fromShape(barrel: Barrel, tank: BarrelBase, tankDefinition: TankDefinition | null, shape: LivingEntity): WraithSquare {
        const sunchip = new WraithSquare(barrel, tank, tankDefinition, shape.positionData.values.angle);
