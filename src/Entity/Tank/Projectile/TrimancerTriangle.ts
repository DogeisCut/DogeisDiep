 ...
 */
export default class TrimancerTriangle extends Drone {
    public constructor(barrel: Barrel, tank: BarrelBase, tankDefinition: TankDefinition | null, shootAngle: number) {
        ...
        this.styleData.values.color = tank.relationsData.values.team?.teamData?.values.teamColor || Color.TeamRed; //TODO: replace color
    ...
    public static fromShape(barrel: Barrel, tank: BarrelBase, tankDefinition: TankDefinition | null, shape: LivingEntity): TrimancerTriangle {
        const sunchip = new TrimancerTriangle(barrel, tank, tankDefinition, shape.positionData.values.angle);
